...
import { MapPin, Plus, Trash2, Navigation, Check, ChevronRight, ChevronLeft, Map, RotateCw, X, Edit2, ChevronDown, ChevronUp, Building2 } from "lucide-react";
...
// ─── Coordinate DB ────────────────────────────────────────────────────────────
const SB_URL = "https://kmfprxbfafbquilgchtv.supabase.co";
const SB_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImttZnByeGJmYWZicXVpbGdjaHR2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI3ODUxODYsImV4cCI6MjA4ODM2MTE4Nn0.09WBWLQMfo_rYhN9MO2fukbd-YLNZMghFf0dCdjs5Jc";
...
async function coordLookup(city, street, number) {
  try {
...
async function coordSave(city, street, number, lat, lon) {
  try {
...
function PlacesTab({ ro, places, onAdd, onUpdate, onDelete }) {
...
function JobsTab({ ro, jobs, vocab, addrBook, onAdd, onUpdate, onDelete }) {
  const [modal,     setModal]     = useState(null);
      ...
      <div style={{ background: C.surface, borderBottom: `1px solid ${C.border}`, position: "sticky", top: 0, zIndex: 20 }}>
        <div style={{ maxWidth: 540, margin: "0 auto", padding: "14px 16px 0" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
            ...
            <span style={{ marginLeft: "auto", fontSize: 11, color: C.muted }}>v30</span>
